    ...
    private class LandscapePanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            for (Edge e : graph.getEdges()) {
                ...
                g.drawLine((int) coords.get(e.getVertices()[0]).x + gridScale / 4,
                        (int) coords.get(e.getVertices()[0]).y + gridScale / 4,
                        (int) coords.get(e.getVertices()[1]).x + gridScale / 4,
                        (int) coords.get(e.getVertices()[1]).y + gridScale / 4);
            }
            for (Vertex v : graph.getVertices()) {
